...
export default function Hobbies() {
    return (
        <Row>
            <IconTextWrapper>
                <Icon color="gray" size="24px"><ImHeadphones /></Icon>
                <Text color="gray" size="24px">Music</Text>
            </IconTextWrapper>
            <IconTextWrapper>
                <Icon color="gray" size="24px"><GrGamepad /></Icon>
                <Text color="gray" size="24px">Gaming</Text>
            </IconTextWrapper>
            <IconTextWrapper>
                <Icon color="gray" size="24px"><GiSecretBook /></Icon>
                <Text color="gray" size="24px">Reading</Text>
            </IconTextWrapper>
            <IconTextWrapper>
                <Icon color="gray" size="24px"><GiCommercialAirplane /></Icon>
                <Text color="gray" size="24px">Traveling</Text>
            </IconTextWrapper>
            <IconTextWrapper>
                <Icon color="gray" size="24px"><GiPhotoCamera /></Icon>
                <Text color="gray" size="24px">Photo Graphy</Text>
            </IconTextWrapper>
            <IconTextWrapper>
                <Icon color="gray" size="24px"><GiVolleyballBall /></Icon>
